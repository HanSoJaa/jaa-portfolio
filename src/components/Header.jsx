              ...
              <nav className="container mx-auto flex items-center justify-between flex-wrap pb-0 px-1">
                ...
                <div className="w-full flex items-center justify-between md:hidden">
                  ...
                  <a href="/" onClick={(e) => handleNavClick(e, '#home')} className="flex items-center gap-3">
                    <div>
                      <h1 className="font-moderniz text-sm dark:text-[#00ffdc] text-slate-800 whitespace-nowrap">Mirza Harith</h1>
                ...
                <div className="hidden w-full md:grid grid-cols-3 items-center px-8 relative min-h-[48px]">
                  ...
                  >
                    <div className="block">
                      <h1 className="font-moderniz text-base dark:text-[#00ffdc] text-slate-800 text-center">Mirza Harith</h1>
                      <p className="font-moderniz text-[10px] dark:text-[#00ffdc] text-slate-600 text-center" style={{ textShadow: 'none' }}>
                        Let's see the awesome Experience
                      </p>
                    </div>
                  </a>
