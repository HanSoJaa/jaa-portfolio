...
const Preloader = ({ onFinished }) => {
  ...
  useEffect(() => {
    ...
    // Safety timeout: Finish preloader after 10 seconds regardless of assets
    const safetyTimer = setTimeout(() => {
      console.warn("Preloader safety timeout triggered");
      setIsAssetLoaded(true); // Force proceed
    }, 10000);
        ...
        >
          {showContent && (
            ...
            >
              ...
              >
                <a href="http://linkedin.com/in/mirza-harith" target="_blank" rel="noopener noreferrer" className="dark:hover:text-[#00ffdc] hover:text-cyan-600 transition-all duration-300 transform hover:scale-110">
                  <Linkedin size={32} />
                </a>
                <a href="https://www.instagram.com/_mirzaharith?igsh=MWZ6ajAzZWp4NmhzZg%3D%3D&utm_source=qr" target="_blank" rel="noopener noreferrer" className="dark:hover:text-[#00ffdc] hover:text-cyan-600 transition-all duration-300 transform hover:scale-110">
                  <Instagram size={32} />
                </a>
              </motion.div>
            </motion.div>
